          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mx-auto mb-10 max-w-2xl text-center">
              ...
              <p className="mt-4 text-slate-600">
                Trabajamos junto a las personas y la comunidad para construir
                una sociedad más abierta e inclusiva.
              </p>
            </div>
            ...
            <div className="grid gap-6 md:grid-cols-3">
              <div className="group rounded-2xl border border-slate-200 bg-slate-50 p-7 transition hover:-translate-y-1 hover:bg-white hover:shadow-xl">
                ...
                <p className="mt-3 leading-relaxed text-slate-600">
                  Orientación e información social y cultural para facilitar la
              ...
              <div className="group rounded-2xl border border-slate-200 bg-slate-50 p-7 transition hover:-translate-y-1 hover:bg-white hover:shadow-xl">
                ...
                <p className="mt-3 leading-relaxed text-slate-600">
                  Creamos redes de apoyo y espacios donde compartir, participar
              ...
              <div className="group rounded-2xl border border-slate-200 bg-slate-50 p-7 transition hover:-translate-y-1 hover:bg-white hover:shadow-xl">
                ...
                <p className="mt-3 leading-relaxed text-slate-600">
                  Talleres, encuentros culturales y actividades abiertas para
                  toda la ciudadanía.
                </p>
              </div>
            </div>
            ...
            <div className="grid items-center gap-12 lg:grid-cols-2">
              <div>
                ...
                <p className="mt-6 text-lg leading-relaxed text-slate-600">
                  ...
                  Vitoria-Gasteiz con el propósito de derribar barreras y
                  fomentar la convivencia intercultural.
                </p>

                <p className="mt-4 leading-relaxed text-slate-600">
                  Creemos en el poder de la comunidad para transformar vidas,
                  ofreciendo herramientas, acompañamiento y oportunidades a
                  quienes comienzan un nuevo camino en Euskadi.
                </p>
              ...
              <div className="mb-10 flex flex-col justify-between gap-4 sm:flex-row sm:items-end">
                <div>
                  ...
                  <p className="mt-3 max-w-2xl text-slate-600">
                    Iniciativas pensadas para fortalecer la autonomía, la
            ...
            <div className="overflow-hidden rounded-3xl bg-gradient-to-br from-emerald-600 to-teal-700 px-6 py-14 text-center text-white shadow-2xl sm:px-12">
              <div className="mx-auto max-w-3xl">
                ...
                <p className="mx-auto mt-4 max-w-2xl text-lg leading-relaxed text-emerald-50">
                  Una sociedad inclusiva se construye entre todas las personas.
                  Conoce nuestro trabajo, colabora con nosotros o simplemente
                  ponte en contacto.
                </p>
